...
class AsciiCode:
  ...
  """
  def __init__(self, arg=None, sequence="", default=''):
...
CursorSet = AsciiCode("@;@H") #Line, Col. (XXX Doesn't work!)
CursorHide = AsciiCode("?25l")
CursorShow = AsciiCode("?25h")
NoScroll = AsciiCode("?1049h")
YesScroll = AsciiCode("?1049l")
...
import os, termios, fcntl, select, struct
...
class terminal:
  ...
  def create_terminal(self):
    ...
    r = os.system(cmd)
    print("\r If this program hangs, press Ctrl-C", )
    #try:
    if 1:
