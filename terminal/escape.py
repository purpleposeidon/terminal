...
ScrollRegion(top, bottom): Sets the scroll region; newlines inserted between top and bottom only scroll the lines there (or something like that). In Konsole, the cursor is moved to CursorHome. In xterm, it is moved to the top of the scroll region. So use CursorSet(top, 1) after.
